...
pub struct Netapi32Handler;

impl Netapi32Handler {
    pub fn new() -> Self {
        Self
    }
}

impl Default for Netapi32Handler {
    fn default() -> Self {
        Self::new()
    }
}

impl ApiHandler for Netapi32Handler {
