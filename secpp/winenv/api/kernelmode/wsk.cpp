...
uint64_t Wsk::WskRegister(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskRegister(WSK_CLIENT_NPI *ClientNpi, WSK_REGISTRATION *WskRegistration)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskCaptureProviderNPI(void* e, ArgList& a, void* ctx) {
...
uint64_t Wsk::WskReleaseProviderNPI(void* e, ArgList& a, void* ctx) {
    // VOID WskReleaseProviderNPI(WSK_REGISTRATION *WskRegistration)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskDeregister(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskDeregister(WSK_REGISTRATION *WskRegistration)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskSocket(void* e, ArgList& a, void* ctx) {
...
uint64_t Wsk::WskSocketConnect(void* e, ArgList& a, void* ctx) {
    // PWSK_SOCKET WskSocketConnect(...)
    (void)e; (void)a;
    return 0;
}

uint64_t Wsk::WskControlClient(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskControlClient(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskGetAddressInfo(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskGetAddressInfo(...)
    (void)e; (void)a;
    return 0x000000C0000135L; // STATUS_NOT_FOUND
}

uint64_t Wsk::WskFreeAddressInfo(void* e, ArgList& a, void* ctx) {
    // VOID WskFreeAddressInfo(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskGetNameInfo(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskGetNameInfo(...)
    (void)e; (void)a;
    return 0x000000C0000135L; // STATUS_NOT_FOUND
}

uint64_t Wsk::WskControlSocket(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskControlSocket(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskCloseSocket(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskCloseSocket(PWSK_SOCKET Socket, ...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskBind(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskBind(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskSendTo(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskSendTo(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskReceiveFrom(void* e, ArgList& a, void* ctx) {
    // NTSTATUS WskReceiveFrom(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskRelease(void* e, ArgList& a, void* ctx) {
    // VOID WskRelease(...)
    (void)e; (void)a;
    return WSK_SUCCESS;
}

uint64_t Wsk::WskGetLocalAddress(void* e, ArgList& a, void* ctx) {
