...
uint64_t Ndis::NdisGetVersion(void* e, ArgList& a, void* ctx) {
    // UINT NdisGetVersion();
    (void)a;
...
uint64_t Ndis::NdisGetRoutineAddress(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisMRegisterMiniportDriver(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisInitializeWrapper(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisTerminateWrapper(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Ndis::NdisInitializeReadWriteLock(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Ndis::NdisMRegisterUnloadHandler(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Ndis::NdisRegisterProtocol(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisIMRegisterLayeredMiniport(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisIMAssociateMiniport(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Ndis::NdisAllocateGenericObject(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisAllocateMemoryWithTag(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisAllocateNetBufferListPool(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisFreeNetBufferListPool(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisFreeMemory(void* e, ArgList& a, void* ctx) {
...
uint64_t Ndis::NdisFreeGenericObject(void* e, ArgList& a, void* ctx) {
