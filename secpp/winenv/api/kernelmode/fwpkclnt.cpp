...
uint64_t Fwpkclnt::FwpmEngineClose0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    // DWORD FwpmEngineClose0(HANDLE engineHandle)
    (void)e; (void)a;
    return 0;
}

uint64_t Fwpkclnt::FwpmSubLayerAdd0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Fwpkclnt::FwpmSubLayerDeleteByKey0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    // DWORD FwpmSubLayerDeleteByKey0(HANDLE engineHandle, const GUID* key)
    (void)e; (void)a;
    return 0;
}

uint64_t Fwpkclnt::FwpmCalloutAdd0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    // DWORD FwpmCalloutAdd0(engineHandle, callout, sd, flags)
    (void)e; (void)a;
    return 0; // STATUS_SUCCESS
}

uint64_t Fwpkclnt::FwpmCalloutDeleteById0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    // DWORD FwpmCalloutDeleteById0(engineHandle, UINT32 id)
    (void)e; (void)a;
    return 0;
}

uint64_t Fwpkclnt::FwpmFilterAdd0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Fwpkclnt::FwpmFilterDeleteById0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    // DWORD FwpmFilterDeleteById0(engineHandle, UINT32 id)
    (void)e; (void)a;
    return 0;
}

uint64_t Fwpkclnt::FwpsCalloutRegister1(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Fwpkclnt::FwpsCalloutUnregisterById0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    // NTSTATUS FwpsCalloutUnregisterById0(UINT32 calloutId)
    (void)e; (void)a;
    return 0;
}

uint64_t Fwpkclnt::FwpsInjectionHandleCreate0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Fwpkclnt::FwpsInjectionHandleDestroy0(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
