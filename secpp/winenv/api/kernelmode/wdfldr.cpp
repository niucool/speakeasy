...
uint64_t Wdfldr::WdfVersionBind(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfDriverCreate(void* e, std::vector<uint64_t>& a, void* ctx) {
    // NTSTATUS WdfDriverCreate(DriverGlobals, DriverObject, RegistryPath, DriverAttributes, DriverConfig, Driver)
    (void)e; (void)a;
    return 0; // STATUS_SUCCESS
}

uint64_t Wdfldr::WdfDeviceInitSetPnpPowerEventCallbacks(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceInitSetRequestAttributes(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceInitSetFileObjectConfig(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceInitSetIoType(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceCreate(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfObjectGetTypedContextWorker(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfDriverOpenParametersRegistryKey(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfRegistryQueryULong(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfRegistryClose(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceSetPnpCapabilities(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfIoQueueReadyNotify(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceCreateDeviceInterface(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfIoQueueCreate(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfDeviceWdmGetAttachedDevice(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfDeviceWdmGetDeviceObject(void* e, std::vector<uint64_t>& a, void* ctx) {
    // Return a dummy device object
    size_t psz = static_cast<size_t>(ptr_sz(e));
    (void)psz;
    return mm(e)->mem_map(psz * 16, 0, common::PERM_MEM_RWX, "api.struct.DEVICE_OBJECT");
...
uint64_t Wdfldr::WdfUsbTargetDeviceCreateWithParameters(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbTargetDeviceGetDeviceDescriptor(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfMemoryCreate(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbTargetDeviceSelectConfig(void* e, std::vector<uint64_t>& a, void* ctx) {
    // NTSTATUS WdfUsbTargetDeviceSelectConfig(Handle, Options, Params)
    (void)e; (void)a;
    return 0; // STATUS_SUCCESS
}

uint64_t Wdfldr::WdfUsbTargetDeviceRetrieveConfigDescriptor(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbInterfaceSelectSetting(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfUsbTargetDeviceGetNumInterfaces(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbInterfaceGetNumConfiguredPipes(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbInterfaceGetNumSettings(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbTargetDeviceRetrieveInformation(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Wdfldr::WdfUsbInterfaceGetConfiguredPipe(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbTargetPipeGetInformation(void* e, std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Wdfldr::WdfUsbInterfaceGetInterfaceNumber(void* e, std::vector<uint64_t>& a, void* ctx) {
