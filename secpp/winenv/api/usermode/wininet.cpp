...
//  InternetOpen
// 
uint64_t Wininet::InternetOpen(void* e, std::vector<uint64_t>& a, void* ctx) {
...
//  InternetConnect
// 
uint64_t Wininet::InternetConnect(void* e, std::vector<uint64_t>& a, void* ctx) {
...
//  HttpOpenRequest
// 
uint64_t Wininet::HttpOpenRequest(void* e, std::vector<uint64_t>& a, void* ctx) {
    if (a.size() < 8) return 0;
...
//  InternetCrackUrl
// 
uint64_t Wininet::InternetCrackUrl(void* e, std::vector<uint64_t>& a, void* ctx) {
...
//  InternetSetOption
// 
uint64_t Wininet::InternetSetOption(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 1; // TRUE
}
...
// 
uint64_t Wininet::InternetGetConnectedState(void* e, std::vector<uint64_t>& a, void* ctx) {
...
//  HttpSendRequest
// 
uint64_t Wininet::HttpSendRequest(void* e, std::vector<uint64_t>& a, void* ctx) {
    if (a.size() < 5) return 0;
...
//  InternetErrorDlg
// 
uint64_t Wininet::InternetErrorDlg(void* e, std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
...
//  InternetQueryOption
// 
uint64_t Wininet::InternetQueryOption(void* e, std::vector<uint64_t>& a, void* ctx) {
    if (a.size() < 4) return 0;
    uint64_t hInternet = a[0];
...
//  InternetReadFile
// 
uint64_t Wininet::InternetReadFile(void* e, std::vector<uint64_t>& a, void* ctx) {
    if (a.size() < 4) return 0;
    uint64_t hFile = a[0];
    uint64_t buf = a[1];
...
//  HttpQueryInfo
// 
uint64_t Wininet::HttpQueryInfo(void* e, std::vector<uint64_t>& a, void* ctx) {
    if (a.size() < 5) return 0;
    uint64_t hRequest = a[0];
...
// 
uint64_t Wininet::InternetQueryDataAvailable(void* e, std::vector<uint64_t>& a, void* ctx) {
    if (a.size() < 4) return 0;
    uint64_t hFile = a[0];
...
//  InternetCloseHandle
// 
uint64_t Wininet::InternetCloseHandle(void* e, std::vector<uint64_t>& a, void* ctx) {
...
//  InternetOpenUrl
// 
uint64_t Wininet::InternetOpenUrl(void* e, std::vector<uint64_t>& a, void* ctx) {
