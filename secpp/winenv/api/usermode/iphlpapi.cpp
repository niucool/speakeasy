...
uint64_t Iphlpapi::GetExtendedTcpTable(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    return get_extended_table_impl(e, a);
}
uint64_t Iphlpapi::GetExtendedUdpTable(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    return get_extended_table_impl(e, a);
}
...
uint64_t Iphlpapi::NotifyRouteChange(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a;
    return IPH_NOT_SUPPORTED;
}
...
uint64_t Iphlpapi::FlushIpPathTable(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
...
uint64_t Iphlpapi::GetIpStatisticsEx(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Iphlpapi::GetTcpStatisticsEx(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Iphlpapi::GetUdpStatisticsEx(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Iphlpapi::SetIpTTL(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
...
uint64_t Iphlpapi::AllocateAndGetIpAddrTableFromStack(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    return alloc_and_get_table_impl(e, a, 24, ptr_sz(e));
}
uint64_t Iphlpapi::AllocateAndGetIpNetTableFromStack(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    return alloc_and_get_table_impl(e, a, 24, ptr_sz(e));
}
uint64_t Iphlpapi::AllocateAndGetTcpTableFromStack(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    return alloc_and_get_table_impl(e, a, 24, ptr_sz(e));
}
uint64_t Iphlpapi::AllocateAndGetUdpTableFromStack(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
uint64_t Iphlpapi::UnenableRouter(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
...
uint64_t Iphlpapi::IpRenewAddress(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
...
uint64_t Iphlpapi::PingEx(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
uint64_t Iphlpapi::CancelIPInfoChange(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
uint64_t Iphlpapi::SetAdapterIpAddress(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
...
uint64_t Iphlpapi::DeleteIPAddress(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a; return IPH_OK;
}
