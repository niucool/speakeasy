...
uint64_t Oleaut32::SysAllocString(void* e, ArgList& a, void* ctx) {
    uint64_t psz = a[0];
    if (!psz) return 0;
...
uint64_t Oleaut32::SysAllocStringLen(void* e, ArgList& a, void* ctx) {
...
uint64_t Oleaut32::SysFreeString(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Oleaut32::VariantInit(void* e, ArgList& a, void* ctx) {
    uint64_t pvarg = a[0];
    if (pvarg) {
