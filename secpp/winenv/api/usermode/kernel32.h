...
class Kernel32 : public ApiHandler {
    ...
    API_ENTRY(GetSystemTimeAsFileTime, 1)     API_ENTRY(InterlockedCompareExchange, 3)
    API_ENTRY(InterlockedDecrement, 1)     API_ENTRY(InterlockedExchange, 2)
    API_ENTRY(InterlockedIncrement, 1)     API_ENTRY(TlsAlloc, 0)
