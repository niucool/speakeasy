...
uint64_t Ws2_32::WSAStartup(void* e, ArgList& a, void* ctx) {
...
uint64_t Ws2_32::WSASocketA(void* e, ArgList& a, void* ctx) {
    (void)e;
...
uint64_t Ws2_32::connect(void* e, ArgList& a, void* ctx) {
...
uint64_t Ws2_32::send(void* e, ArgList& a, void* ctx) {
...
uint64_t Ws2_32::recv(void* e, ArgList& a, void* ctx) {
    if (a.size() < 4) return -1;
    uint64_t s = a[0];
    uint64_t buf = a[1];
    uint64_t blen = a[2];
...
uint64_t Ws2_32::closesocket(void* e, ArgList& a, void* ctx) {
    (void)e;
    if (a.size() < 1) return -1;
    return 0;
}
...
uint64_t Ws2_32::bind(void* e, ArgList& a, void* ctx) {
    if (a.size() < 3) return -1;
    uint64_t s = a[0];
    uint64_t pname = a[1];
    uint64_t namelen = a[2];
...
uint64_t Ws2_32::listen(void* e, ArgList& a, void* ctx) {
    (void)e;
    if (a.size() < 2) return -1;
    return 0;
}
...
uint64_t Ws2_32::gethostbyname(void* e, ArgList& a, void* ctx) {
...
//  WSAGetLastError 
// int WSAGetLastError();
uint64_t Ws2_32::WSAGetLastError(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}
...
uint64_t Ws2_32::inet_addr(void* e, ArgList& a, void* ctx) {
...
uint64_t Ws2_32::htons(void* e, ArgList& a, void* ctx) {
    (void)e;
    if (a.size() < 1) return 0;
...
uint64_t Ws2_32::select(void* e, ArgList& a, void* ctx) {
...
uint64_t Ws2_32::stub(void* e, ArgList& a, void* ctx) {
