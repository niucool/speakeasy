...
//  ICOpen
// 
uint64_t Msvfw32::ICOpen(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
...
//  ICSendMessage
// 
uint64_t Msvfw32::ICSendMessage(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 1;
}
...
//  ICClose
// 
uint64_t Msvfw32::ICClose(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a;
    return 1;
}
