...
// 
uint64_t Mpr::WNetOpenEnum(void* e, ArgList& a, void* ctx) {
...
// 
uint64_t Mpr::WNetEnumResource(void* e, ArgList& a, void* ctx) {
    uint64_t hEnum = a[0];
...
// 
uint64_t Mpr::WNetAddConnection2(void* e, ArgList& a, void* ctx) {
...
// 
uint64_t Mpr::WNetGetConnection(void* e, ArgList& a, void* ctx) {
