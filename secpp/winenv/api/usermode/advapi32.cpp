...
//  RegOpenKeyExA 
uint64_t Advapi32::RegOpenKeyExA(void* e, const std::vector<uint64_t>& a, void* ctx) {
...
//  RegQueryValueExA 
uint64_t Advapi32::RegQueryValueExA(void* e, const std::vector<uint64_t>& a, void* ctx) {
...
//  RegCloseKey 
uint64_t Advapi32::RegCloseKey(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; if (a.size()<1) return 0xFFFFFFFF;
    return resolve_hk(a[0]).empty() ? 6 : 0;
}

//  RegCreateKeyExA 
uint64_t Advapi32::RegCreateKeyExA(void* e, const std::vector<uint64_t>& a, void* ctx) {
...
//  RegSetValueExA 
uint64_t Advapi32::RegSetValueExA(void* e, const std::vector<uint64_t>& a, void* ctx) {
    if (a.size()<6) return 0xFFFFFFFF;
...
//  RegDeleteKeyA 
uint64_t Advapi32::RegDeleteKeyA(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a; return 0;
}

//  OpenProcessToken 
uint64_t Advapi32::OpenProcessToken(void* e, const std::vector<uint64_t>& a, void* ctx) {
...
uint64_t Advapi32::LookupPrivilegeValueA(void* e, const std::vector<uint64_t>& a, void* ctx) {
    if (a.size()<3||!a[2]) return 0;
...
uint64_t Advapi32::AdjustTokenPrivileges(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a; return 1;
}

//  CryptAcquireContextA 
uint64_t Advapi32::CryptAcquireContextA(void* e, const std::vector<uint64_t>& a, void* ctx) {
...
//  CryptGenRandom 
uint64_t Advapi32::CryptGenRandom(void* e, const std::vector<uint64_t>& a, void* ctx) {
...
//  CreateServiceA 
uint64_t Advapi32::CreateServiceA(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a; static uint64_t ns=0x3000; ns+=4; return ns;
}

//  StartServiceA 
uint64_t Advapi32::StartServiceA(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a; return 1;
}

uint64_t Advapi32::stub(void* e, const std::vector<uint64_t>& a, void* ctx) {
    (void)e; (void)a; return 1;
}
