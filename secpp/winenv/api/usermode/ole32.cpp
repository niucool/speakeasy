...
uint64_t Ole32::CoInitialize(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}

uint64_t Ole32::CoUninitialize(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Ole32::CoCreateInstance(void* e, ArgList& a, void* ctx) {
...
uint64_t Ole32::CoGetClassObject(void* e, ArgList& a, void* ctx) {
...
uint64_t Ole32::CLSIDFromString(void* e, ArgList& a, void* ctx) {
...
uint64_t Ole32::StringFromGUID2(void* e, ArgList& a, void* ctx) {
...
uint64_t Ole32::ProgIDFromCLSID(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}

uint64_t Ole32::CLSIDFromProgID(void* e, ArgList& a, void* ctx) {
...
uint64_t Ole32::OleInitialize(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}

uint64_t Ole32::OleUninitialize(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0;
}

uint64_t Ole32::OleSetClipboard(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}

uint64_t Ole32::OleGetClipboard(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 1; // S_FALSE
}

uint64_t Ole32::OleFlushClipboard(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}

uint64_t Ole32::OleIsCurrentClipboard(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 1; // S_FALSE
}

uint64_t Ole32::CreateBindCtx(void* e, ArgList& a, void* ctx) {
...
uint64_t Ole32::BindMoniker(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}

uint64_t Ole32::MkParseDisplayName(void* e, ArgList& a, void* ctx) {
    (void)e; (void)a;
    return 0; // S_OK
}
