...
//  GetUserNameEx
// 
uint64_t Secur32::GetUserNameEx(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
...
//  EncryptMessage
// 
uint64_t Secur32::EncryptMessage(void* e, const std::string&, int, const std::vector<uint64_t>& a) {
    (void)e; (void)a;
